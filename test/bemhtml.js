...
describe('Вызов генератор direct:bemhtml', function () {
    [
        ...
        },
        {
            ...
            asserts: [
                {
                    path: 'b-some/_kind/b-some_kind_inline.bemhtml',
                    decl: 'block b-some, mod kind inline'
                },
                {
                    path: 'b-some/_type/b-some_type_inline.bemhtml',
                    decl: 'block b-some, mod type inline'
                },
                {
                    path: 'b-some/_kind/b-some_kind_block.bemhtml',
                    decl: 'block b-some, mod kind block'
                },
                {
                    path: 'b-some/_type/b-some_type_block.bemhtml',
                    decl: 'block b-some, mod type block'
                },
                {
                    path: 'b-other/_kind/b-other_kind_inline.bemhtml',
                    decl: 'block b-other, mod kind inline'
                },
                {
                    path: 'b-other/_type/b-other_type_inline.bemhtml',
                    decl: 'block b-other, mod type inline'
                },
                {
                    path: 'b-other/_kind/b-other_kind_block.bemhtml',
                    decl: 'block b-other, mod kind block'
                },
                {
                    path: 'b-other/_type/b-other_type_block.bemhtml',
